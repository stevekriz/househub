...
describe("Reviews", () => {
  it("should render the reviews passed in as a prop", () => {
    expect(
          ...
          reviews={[
            {
              ...
              profilePicture:
                "https://airbnbfec.s3-us-west-1.amazonaws.com/34.jpeg",
            },
          ]}
          viewPortWidth={1280}
        />
      ...
      "RebeccaDecember 2020Ad quisquam ea vero minima. Voluptas voluptatem voluptas beatae illum dolor dolorum recusandae non omnis. Nobis sequi et eveniet. Et necessitatibus ratione fuga sit ut saepe quas v... read more"
    );
  });
});
